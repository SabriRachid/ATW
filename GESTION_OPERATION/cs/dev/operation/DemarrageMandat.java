...
import com.serviceRH.CreerFichierProperties;


/**
 * @AUTHOR R.SABRI
 * @CREATION_DATE 24/10/2017 11:37 AM
 * @PLATEFORM VDOC14 2.1 
 */
public class DemarrageMandat extends BaseDocumentExtension{

    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    protected static final Logger log = Logger.getLogger(DemarrageMandat.class);
    private String SMTP;
    private String IPVDoc;
    private String SMM;
    private String SMI;
    private String domaine = "@attijari.ma";
    // ========================================================================
    // onAfterSubmit
    // ========================================================================
    @Override
    public boolean onAfterSubmit(IAction action) {
        if (action.getName().equals("GO_Demarrer"))
        {
            try
            {
                ...
                /*
                SMTP = getWorkflowInstance().getCatalog().getConfiguration().getStringUserProperty("ATTIP");
                 ...
                 */
                IPVDoc = prop.getProperty("IPADRESSE");
                SMTP = prop.getProperty("SMTPADRESS");
                SMM = prop.getProperty("SMM");
                SMI = prop.getProperty("SMI");
                String Email_Collab ="";
                String NatureService = (String) getWorkflowInstance().getValue("GO_NatureService");
                if (NatureService.equals("National"))
                {
                    Email_Collab = SMM + domaine; // SMM "f.squalli@attijari.ma"
                }else {
                    Email_Collab = SMI + domaine; // SMI "d.nejjar@attijari.ma"
                }
                //String refVdoc=(String) getWorkflowInstance().getValue("sys_Reference");
                String mailContent ="";
                String Commentaire ="Le mandat à été démarré";
                ...
                //for(IUser ligne : SMM_role){
                    ...
                    mailContent = "<table border='0' cellpadding='0' cellspacing='0' width='100%'>" + 
                            ...
                            "<p>Visualisez le document :&nbsp; : <a href='"+IPVDoc+"'/vdoc/portal/default/portal-tab-workspace'>"+(String) getWorkflowInstance().getValue("GO_NomProjet")+"-"+ (String) getWorkflowInstance().getValue("sys_Reference")+"</a></p>" + 
                            ...
                            "<td colspan='75' style='background-color:#FFFFFF; padding:8px; text-align:left; font-family: Arial; font-size: 12px; border-bottom: 1px solid #d0d5d7' valign='top' width='75%'>"+Commentaire+"</td>" + 
                            "</tr>" + 
                            "</tbody>" + 
                            "</table>" + 
                            "</td>" + 
                    ...
                    // Envoi mail
                    sendEmailSMI(SMTP,email_assi,mailContent, Email_Collab);
               // }
            }catch(Exception e)
            {
                e.printStackTrace();
    ...
    // =========================================================================
    public void sendEmailSMI(String smtp, String Assisstante, String TexteEmail,String Collaborateurs)
    {    
        ...
        try{
            ...
            message.setSubject("Démarrage mandat");
